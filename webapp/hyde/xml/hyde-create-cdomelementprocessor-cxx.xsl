...
<!--==========================================================-->
<!--                                                          -->
<!--   File: hyde-create-cdomelementprocessor-cxx.xsl         -->
<!--                                                          -->
<!-- Author: $author$                                        -->
<!--   Date: 12/11/2004                                       -->
<!--                                                          -->
...
<xsl:param name="hyde_form_title" select="'Create cDOMElementProcessor C++ Class'"/>
<xsl:param name="hyde_form_submit" select="'Submit'"/>
<xsl:param name="hyde_form_method" select="'post'"/>
<xsl:param name="hyde_form_action" select="'cdomelementprocessor-cxx.t'"/>
<xsl:param name="hyde_form_default_output_type" select="'text'"/>

<!--==========================================================-->
<!--                                                          -->
<!-- Template form_cdomelementprocessor_parameters                           -->
<!--                                                          -->
<!--==========================================================-->
<xsl:template name="form_cdomelementprocessor_parameters">
    <xsl:call-template name="section_row">
        <xsl:with-param name="text" select="'cDOMElementProcessor Parameters'"/>
    </xsl:call-template>
...
<xsl:template name="form_fields">
    ...
    <xsl:call-template name="form_cdomelementprocessor_parameters"/>
