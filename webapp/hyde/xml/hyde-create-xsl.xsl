...
<xsl:param name="hyde_form_title" select="'Create XSLT File'"/>
<xsl:param name="hyde_form_submit" select="'Submit'"/>
<xsl:param name="hyde_form_method" select="'post'"/>
<xsl:param name="hyde_form_action" select="'/hyde/t/xsl.t'"/>
...
<xsl:template name="form_fields">
    ...
    <xsl:call-template name="form_xsl_parameters"/>
    <xsl:call-template name="form_hyde_xsl_parameters"/>
